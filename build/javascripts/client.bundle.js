(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		var a = typeof exports === 'object' ? factory(require("superagent")) : factory(root[undefined]);
...
/******/ 	__webpack_require__.p = "/partners/prime/assets/";
/******/
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__connect_connect__ = __webpack_require__(25);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__utils_Subscription__ = __webpack_require__(24);
...
/* unused harmony export default */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_lodash_es_isPlainObject__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__warning__ = __webpack_require__(1);
...
var m=__webpack_require__(3),n=__webpack_require__(17),p=__webpack_require__(4),q="function"===typeof Symbol&&Symbol["for"],r=q?Symbol["for"]("react.element"):60103,t=q?Symbol["for"]("react.call"):60104,u=q?Symbol["for"]("react.return"):60105,v=q?Symbol["for"]("react.portal"):60106,w=q?Symbol["for"]("react.fragment"):60107,x="function"===typeof Symbol&&Symbol.iterator;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__utils_warning__ = __webpack_require__(1);
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__utils_shallowEqual__ = __webpack_require__(26);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__mapDispatchToProps__ = __webpack_require__(27);
...
"use strict";
/* WEBPACK VAR INJECTION */(function(global, module) {/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__ponyfill_js__ = __webpack_require__(38);
/* global window */
...
/* WEBPACK VAR INJECTION */}.call(__webpack_exports__, __webpack_require__(12), __webpack_require__(37)(module)))
...
var fetchData = function fetchData() {
  return _superagent2.default.get('https://api.github.com/users/mralexgray/repos').then(function (response) {
    return response.body;
  });
};

var TestDashboard = function TestDashboard(props) {
...
exports.default = (0, _reactRedux.connect)(mapStateToProps)(TestDashboard);
...
var __DEV__ = process.env && "production" === "development";
...
exports.default = function (initialState) {
  ...
  // ======================================================
  var store = (0, _redux.createStore)(_reducers2.default, initialState, composeEnhancers.apply(undefined, [_redux.applyMiddleware.apply(undefined, middlewares)].concat(enhancers)));
  ...
  try {
    (0, _reactDom.render)(_react2.default.createElement(
      ...
      _react2.default.createElement(
        "div",
        null,
        _react2.default.createElement(_application2.default, { component: component })
      )
...
var onNavigation = (0, _navigation2.default)(renderApp, store);

_history2.default.listen(function (location) {
  onNavigation(window.location.pathname, _queryString2.default.parse(window.location.search));
});
...
*/
var aa=__webpack_require__(0),l=__webpack_require__(57),B=__webpack_require__(3),C=__webpack_require__(4),ba=__webpack_require__(58),da=__webpack_require__(59),ea=__webpack_require__(60),fa=__webpack_require__(61),ia=__webpack_require__(64),D=__webpack_require__(17);
...
var _universalRouter = __webpack_require__(74);
...
var _test_dashboard = __webpack_require__(46);

var _test_dashboard2 = _interopRequireDefault(_test_dashboard);
...
var routes = [{
  ...
  action: function action(context) {
    return (0, _test_dashboard.fetchData)().then(function (payload) {
      context.store.dispatch({
        type: "update_data",
        payload: payload
      });
      return _react2.default.createElement(_test_dashboard2.default, null);
    });
  }
}];

var createRouteWithContext = function createRouteWithContext(store) {
  var context = {
    store: store
  };

  return new _universalRouter2.default(routes, { context: context });
};

var onClientNavigation = function onClientNavigation(callback, store) {
  var router = createRouteWithContext(store);
  return function (pathname) {
    var queryParams = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};

    router.context.queryParams = queryParams;

    callback(_react2.default.createElement(
      "div",
      null,
      "Loading.."
    ));
    router.resolve(pathname).then(function (result) {
      callback(result);
    }).catch(function (err) {
      callback(_react2.default.createElement(
        "div",
...
exports.default = onClientNavigation;
...
var pathToRegexp = _interopDefault(__webpack_require__(75));
...
if(false) {
	module.hot.accept("!!../../node_modules/postcss-loader/lib/index.js??ref--2-1!../../node_modules/sass-loader/lib/loader.js!./main.scss", function() {
		var newContent = require("!!../../node_modules/postcss-loader/lib/index.js??ref--2-1!../../node_modules/sass-loader/lib/loader.js!./main.scss");
...
module.exports = ".pink{background-color:grey}\n"
